...
class TestIntegrationDatasheetSpheresMasks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.day_measures_filename = self.datetime_experiment + 'comparative_by_day_mask.csv'
        ...
        self.headers_optimization = ['camera_option', 'pixel_option', 'size_estimation_option', 'depth_option', 'mass_estimation_option',
                                     ...
                                     'RMSE', 'MAPE', 'R2']
        self.optimization_filename = self.datetime_experiment + 'optimization_results_fruits_m.csv'
        ...
        # --------------------------------------
        tree_selector = '2'
        #lab_input_filename = 'fruit_measures_ALL_TREES_01-12_comma_id_v1.csv'  # HERE WE DEFINE THE NAME OF MANUAL MEASURES
        lab_input_filename = 'SELECTED_fruit_measures_v3.csv'
    ...
    def mask_simulation_method_1(self):
        ...
        self.size_estimation_selector = SizeEstimationSelector.EF
        print(self.size_estimation_selector.name)
        self.depth_option = DepthSelector.AVG
    ...
    def mask_simulation_method_6(self):
        self.roi_selector = ROISelector.MASK
        self.size_estimation_selector = SizeEstimationSelector.CE
        print(self.size_estimation_selector.name)
        self.depth_option = DepthSelector.AVG
        self.mass_estimation_option = MassEstimationModelSelector.NONE
        self.data_features_options = DataFeatureConfig(camera_conf=self.camera_option.rgb_sensor,
    ...
    def mask_simulation_method_11(self):
        self.roi_selector = ROISelector.MASK
        self.size_estimation_selector = SizeEstimationSelector.RR
        print(self.size_estimation_selector.name)
        self.depth_option = DepthSelector.AVG
        self.mass_estimation_option = MassEstimationModelSelector.NONE
        self.data_features_options = DataFeatureConfig(camera_conf=self.camera_option.rgb_sensor,
